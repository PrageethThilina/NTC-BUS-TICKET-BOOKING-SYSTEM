...
$route['Passenger/lockscreen']         = 'Passenger_Controllers/Passenger_Login/lockscreen';
$route['Passenger/Dashboard']    = 'Passenger_Controllers/Passenger_Dashboard/load_passenger_dashboard_view';
$route['Passenger/update_profile']    = 'Passenger_Controllers/Passenger_Login/update_passenger_details';
...
$route['Passenger/get-start-locations']    = 'Passenger_Controllers/Passenger_Dashboard/fetch_locations';
$route['Passenger/fetch-availble-buses']    = 'Passenger_Controllers/Passenger_Dashboard/fetch_available_buses';
...
$route['Passenger/view_bus_seats/(:any)']               = 'Passenger_Controllers/Passenger_Dashboard/passenger_view_bus_seats/$1';

            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content" style="height: 500px;">
                        ...
                        <h3><?php echo $session['ntc_psg_fname']; ?></h3>
                        <p>Please Re-Enter Loging Details to Access NTC Sri Lanka</p>

                        <form class="text-left" role="form" id="loginform"
                            action="<?php echo base_url('Passenger_Controllers/Passenger_Login/login'); ?>">
                            ...
                            <div class="form">
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <h6 class="form_validation_error text-center">
                                        <?php echo form_error('ntc_psg_password') ?></h6>
                                </div>
                ...
                success: function(data) {
                    ...
                    if (obj.status == 0) {
                        $("#error").html(
                            ...
                            obj.error + '  </strong></div>');
                    } else {
                        $("#error").html(
                            '<div class="alert alert-success animated fadeInDown"><strong> Logged Successfully! </strong></div>'
                        );

                            ...
                            <div class="form">
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="<?php echo base_url('Passenger/password_recovery') ?>" class="forgot-pass-link">Forgot Password?</a>
                                    </div>
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div class="field-wrapper">
                                        <a class="btn btn-primary" style="width: 100%;">Sign In</button></a>
                                    </div>
                                </div>

                                <p class="signup-link">Not registered ? <a href="<?php echo base_url('Passenger/register') ?>">Create an account</a></p>
                            </div>
                        </form>

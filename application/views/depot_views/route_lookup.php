            ...
            <div class="row layout-top-spacing" id="cancel-row">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        ...
                        <div class="col">
                            <h3 class="d-inline-block">Route Lookup</h3>
                            <button type="button" class="btn btn-success mb-2" style="float: right;"><a href="route_creation.html">Add
                                Route</a></button>
                            ...
                            <nav class="breadcrumb-one" aria-label="breadcrumb">
                                <ol class="breadcrumb" style="width: 100%;">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Route Lookup</li> 
                                </ol>
                            </nav>        
                        </div>
                        ...
                        <div class="table-responsive mb-4 mt-4">
                            <table id="list_route_table" class="table table-hover non-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Total time slots</th>

  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel" data-interval="4000">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active" style="height: 500px">
        <img class="d-block w-100" src="<?php echo asset_url();?>assets/img/img3.1.jpg" alt="First slide" style="height:500px">
        <div class="carousel-caption d-none d-sm-block">
          <h3>To Develop an Effective Transportation Network!</h3>
          <h5>Ensure a quality, cost effective and safe integrated transport system and services that will provide for
            the socio-economic development across the country and the different mobility requirements of every
            individual and corporate citizen of Sri Lanka.</h5>
        </div>
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="<?php echo asset_url();?>assets/img/img3.2.jpg" alt="Second slide" style="height:500px">
        <div class="carousel-caption d-none d-sm-block">
          <h3>To Develop an Effective Transportation Network!</h3>
          <h5>Ensure a quality, cost effective and safe integrated transport system and services that will provide for
            the socio-economic development across the country and the different mobility requirements of every
      ...
      <div class="carousel-item">
        <img class="d-block w-100" src="<?php echo asset_url();?>assets/img/img3.1.jpg" alt="Third slide" style="height:500px">
        <div class="carousel-caption d-none d-sm-block">
          <h3>To Develop an Effective Transportation Network!</h3>
          <h5>Ensure a quality, cost effective and safe integrated transport system and services that will provide for
            the socio-economic development across the country and the different mobility requirements of every
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="card component-card_1" style="border: 1px solid rgb(87, 25, 25);">
          ...
          <div class="card-body">
            <i class="fa fa-phone" style="display: flex;margin-right: 20px;"><span style="margin-left: 20px;">
    ...
    <div class="container text-center text-md-left mt-5">
      <div class="row mt-3" data-aos="fade-right">
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <p>Ensure a quality, cost effective and safe integrated transport system and services that will provide for
            the socio-economic development across the country and the different mobility requirements of every
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p>
            ...
            Sri Lanka.</p>
          <p>
            <i class="fa fa-envelope mr-3"></i>info@ntc.gov.lk</p>
          <p>
            <i class="fa fa-phone mr-3"></i>+94 011-2587372</p>
        </div>
      </div>
    </div>
  </footer>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6" style="padding-left: 20px;" data-aos="flip-left">
          ...
          <div>
            <ul class="list-unstyled list-inline text-center">
              <li class="list-inline-item"><a href="https://www.facebook.com/" class="btn-floating btn-gplus mx-1"> <i
                    class="fa fa-facebook-f"></i></a></li>
              <li class="list-inline-item"><a href="https://twitter.com/" class="btn-floating btn-gplus mx-1"><i
                    class="fa fa-twitter"></i></a></li>
              <li class="list-inline-item"><a href="https://plus.google.com/u/0/" class="btn-floating btn-gplus mx-1"><i
        ...
        <div class="col-lg-6 col-md-6 col-sm-6" data-aos="flip-right" style="padding-left: 50px;">
          ...
          <p class="contact-para"><strong class="contact-strong">Email : </strong><a
              href="mailto:name@example.com"><span style="color:#fff;margin-left: 65px;">info@ntc.gov.lk</span></a></p>
          <p class="contact-para"><strong class="contact-strong">Address : </strong><span class="abcde">National

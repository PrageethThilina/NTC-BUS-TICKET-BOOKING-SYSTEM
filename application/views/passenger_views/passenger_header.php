...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo asset_url();?>assets/css/dashboard/dash_1.css">
                ...
                <li class="nav-item dropdown language-dropdown more-dropdown">
                    <div class="dropdown  custom-dropdown-icon">
                        <a class="dropdown-toggle btn" href="#" role="button" id="customDropdown" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false"><img src="<?php echo asset_url();?>assets/img/ca.png" class="flag-width"
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">
                            <a class="dropdown-item" data-img-value="de" data-value="Sinhala"
                                href="javascript:void(0);"><img src="<?php echo asset_url();?>assets/img/de.png" class="flag-width" alt="flag">
                                Sinhala</a>
                            <a class="dropdown-item" data-img-value="jp" data-value="Tamil"
                                href="javascript:void(0);"><img src="<?php echo asset_url();?>assets/img/jp.png" class="flag-width" alt="flag">
                                Tamil</a>
                            <a class="dropdown-item" data-img-value="ca" data-value="English"
                                href="javascript:void(0);"><img src="<?php echo asset_url();?>assets/img/ca.png" class="flag-width" alt="flag">
                                English</a>
                        </div>
                    </div>
                </li>
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        <div class="">
                            <div class="dropdown-item">
                                <a class="" href="<?php echo base_url('Passenger/profile') ?>"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="dropdown-item">
                                <a class="" href="<?php echo base_url('Passenger/mail_box') ?>"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="dropdown-item">
                                <a class="" href="<?php echo base_url('Passenger/login') ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24"

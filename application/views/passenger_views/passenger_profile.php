        ...
        <div id="content" class="main-content">
                        ...
                        <div class="user-profile layout-spacing">
                            <div class="widget-content widget-content-area">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="passenger_profile_setting.html" class="mt-2 edit-profile"> <svg
                                ...
                                <div class="text-center user-info">
                                    <img src="assets/img/user1.jpg" alt="avatar" width="400px" height="400px">
                                    <p class="">Prageeth Thilina</p>
                                </div>
            ...
            <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © 2020 <a target="_blank" href="homepage.html">NTC Sri Lanka</a>, All rights
                        reserved.</p>
                </div>
            </div>
        </div>
